...
const ListItem = props => {
  ...
  const _titleComponent = (titleComponent) ? titleComponent : (
  ...
  // It's very ugly hack ....
  const _rightTitleComponent = rightTitleComponent
    //const _rightTitleComponent = (rightTitleComponent) ? rightTitleComponent : (
    //  {rightTitle &&
    //    rightTitle !== '' &&
    //    !textInput && (
    //      <View
...
ListItem.propTypes = {
  ...
  rightTitleComponent: PropTypes.any,
